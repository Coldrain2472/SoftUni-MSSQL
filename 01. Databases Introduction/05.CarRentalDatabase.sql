...
INSERT INTO [Cars] 
  VALUES
  ('CB 2659 BM', 'Volkswagen', 'Golf', 1994, 1, 4, NULL, 'Good', 1),
  ('H 6336 BT', 'Toyota', 'Highlander', 2021, 2, 4, NULL, 'Great', 1),
  ('X 1360 TX', 'Volkswagen', 'Passat', 2054, 3, 10, NULL, 'Best', 0)

INSERT INTO [Employees] 
  VALUES
  ('Amelia', 'Grey', 'Manager', NULL),
  ('John', 'Doe', 'Cashier', NULL),
  ('Jane', 'Jackson', 'Sales associate', NULL)
